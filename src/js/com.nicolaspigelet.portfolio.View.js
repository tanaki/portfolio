 ...
 * @constructor
 */
com.nicolaspigelet.portfolio.View = function( model, controller, dom ) {
 ...
 * @type {string}
 */
com.nicolaspigelet.portfolio.View.TIME_PREFIX = "The Time Is: ";

/**
 * Updates the current time displayed in the view
 * @param {Date} time The time to display
 */
com.nicolaspigelet.portfolio.View.prototype.updateTime = function( time ) {
	this._dom.output.html( com.nicolaspigelet.portfolio.View.TIME_PREFIX + time.toString() );
}